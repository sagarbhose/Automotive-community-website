...
<?php
session_start();
$username_from_session=$_SESSION["username_fetched"];
$con=mysqli_connect('localhost','root','','peopleinfo');
$query="SELECT username,content FROM blogs where username LIKE '$username_from_session'";
